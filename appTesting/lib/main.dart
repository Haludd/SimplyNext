    ...
    canvas.drawRect(
      ...
      Paint()
        ..shader = const LinearGradient(
          colors: <Color>[Color(0xFF193B49), Color(0xFF0C2030)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ).createShader(rect),
    );
    final grid = Paint()
      ..color = const Color(0x184EDDEA)
      ..strokeWidth = 1;
