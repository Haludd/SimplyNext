...
# This union is intentionally separate from ``OutboundEvent``. The legacy landmark
# protocol uses several of the same discriminator strings with incompatible fields.
