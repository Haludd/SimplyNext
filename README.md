...
|-- ref_index.md            RIX      registry and addressing scheme
...
No calibrated recognition bundle is committed yet. The service therefore starts safely but reports
the recognizer as unavailable and emits repair requests instead of captions.
